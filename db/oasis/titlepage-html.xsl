...
<xsl:template name="article.titlepage.recto">
  ...
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/releaseinfo[not(@role) or (@role != 'subject-keywords' and                                               @role != 'topic')]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/releaseinfo[not(@role) or (@role != 'subject-keywords' and                                               @role != 'topic')]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/releaseinfo[not(@role) or (@role != 'subject-keywords' and                                               @role != 'topic')]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/authorgroup"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/authorgroup"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/authorgroup"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/releaseinfo[@role = 'subject-keywords']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/releaseinfo[@role = 'subject-keywords']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/releaseinfo[@role = 'subject-keywords']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/releaseinfo[@role = 'topic']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/releaseinfo[@role = 'topic']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/releaseinfo[@role = 'topic']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/legalnotice[not(@role) or (@role != 'status' and                                               @role != 'notices' and                                               @role != 'related' )]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/legalnotice[not(@role) or (@role != 'status' and                                               @role != 'notices' and                                               @role != 'related' )]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/legalnotice[not(@role) or (@role != 'status' and                                               @role != 'notices' and                                               @role != 'related' )]"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/abstract"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/abstract"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/abstract"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/legalnotice[@role = 'related']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/legalnotice[@role = 'related']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/legalnotice[@role = 'related']"/>
  ...
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/legalnotice[@role = 'status']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="articleinfo/legalnotice[@role = 'notices']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="artheader/legalnotice[@role = 'notices']"/>
  <xsl:apply-templates mode="article.titlepage.recto.auto.mode" select="info/legalnotice[@role = 'notices']"/>
</xsl:template>
